<?php
/*
Template for Column Category Archive
*/
?>
<!DOCTYPE html>
  ...
  <main class="Media">
    ...
    <div class="Wrapper">
      <section class="content">
        ...
        <ul class="Categories">
          <li>
            <a href="<?php echo home_url('/column/'); ?>">すべて</a>
          </li>
          <?php
          ...
          if ($column_categories && !is_wp_error($column_categories)) {
        ...
        <div class="section">
          <ul class="MediaList">
            ...
            <?php
              ...
              echo '<li class="item">該当するコラムがありません。</li>';
            }
            ?>
          </ul>
        </div>
